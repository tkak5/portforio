    ...
    <section className="container px-5 py-24 mx-auto">
      ...
      <ul className="flex flex-wrap">
        {allWorksData.map(({id, title, category, techs, url, photo, git, comment}) => (
          <li id={id} className="p-4">
            <div className="h-full border-2 border-gray-200 rounded-lg overflow-hidden md:flex">
              <div className="p-6">
                <p>{category}({title})</p>
                <ul className="my-2">
              ...
              <div className="w-full object-cover object-center md:border-l-2">
